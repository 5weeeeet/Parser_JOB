from utils import get_result_choise_platform, save_excel, get_top_vacancy, get_vacancies_with_salary, get_vacancies_without_experience, get_vacancies_internship
